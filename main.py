...
print(f"Still, {name} was the best coder on the team and could write {number} lines of code every day. Maybe {song} was {name}'s secrect power?")
...
age_of_hancockHighSchool = input("What is the of hancock high school? ")
#print out the age of hancock high school and your age in a sentence
print(f"I am {age} years old and my high school is {age_of_hancockHighSchool} years old.")
